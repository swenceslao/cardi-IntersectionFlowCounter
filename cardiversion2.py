...
def textDisp(framenumber,image,currentcars,carids,fps,frames_count,a,b,c,d):
   ...
   # cv2.putText(image, 'Time: ' + str(round(framenumber / fps, 2)) + ' sec of ' + str(round(frames_count / fps, 2))
    ...
    cv2.putText(image, "1: "  ,  (175, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    cv2.putText(image, "Pred:  " + str(a) , (175, 45), cv2.FONT_HERSHEY_SIMPLEX, .4,
                    (255,255,255), 1)


    cv2.putText(image, "2: " , (250, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    cv2.putText(image, "Pred: " + str(b), (250,45), cv2.FONT_HERSHEY_SIMPLEX, .4,(255,255,255), 1)
   

    cv2.putText(image, "3: " , (325, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    cv2.putText(image, "Pred:  " + str(c) , (325,45), cv2.FONT_HERSHEY_SIMPLEX, .4,
                    (255,255,255), 1)


    cv2.putText(image, "4: " , (400, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    cv2.putText(image, "U:  " + str(d), (400,45), cv2.FONT_HERSHEY_SIMPLEX, .4,
                    (255,255,255), 1)
