                        ...
                        # acquires delta values of the minimum deltas in order to check if it is within radius later on
                            ...
                            # if delta values are less than maximum radius then add that centroid to that specific carid
                                ...
                                # adds centroid to corresponding previously existing carid
                                        ...
                                        df2.at[count,'eframe'] = framenumber
                                        df2.at[count,'endx'] = cxx[minx_index]
                                        df2.at[count,'endy'] = cyy[minx_index]

                                        x1 = df2.iloc[int(carids[j])]['startx']
                                        y1 = df2.iloc[int(carids[j])]['starty']

                                        lineAngle = getAngle(x1,y1,cxx[minx_index],cyy[minx_index])
...
def textDisp(framenumber,image,currentcars,carids,fps,frames_count):
   ...
   # cv2.putText(image, 'Time: ' + str(round(framenumber / fps, 2)) + ' sec of ' + str(round(frames_count / fps, 2))
    ...
    cv2.putText(image, "Directions: " , (175, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    
   
    cv2.putText(image, "1: " , (250, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    cv2.putText(image, "Pred:  " , (250, 45), cv2.FONT_HERSHEY_SIMPLEX, .4,
                    (255,255,255), 1)


    cv2.putText(image, "2: " , (325, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    cv2.putText(image, "Pred: " , (325,45), cv2.FONT_HERSHEY_SIMPLEX, .4,(255,255,255), 1)
   

    cv2.putText(image, "3: " , (400, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    cv2.putText(image, "Pred:  " , (400,45), cv2.FONT_HERSHEY_SIMPLEX, .4,
                    (255,255,255), 1)


    cv2.putText(image, "4: " , (475, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    cv2.putText(image, "Pred:  " , (475,45), cv2.FONT_HERSHEY_SIMPLEX, .4,
                    (255,255,255), 1)


    cv2.putText(image, "5: " , (550, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    cv2.putText(image, "Pred:  " , (550,45), cv2.FONT_HERSHEY_SIMPLEX, .4,
                    (255,255,255), 1)


    cv2.putText(image, "6: " , (625, 15), cv2.FONT_HERSHEY_SIMPLEX, .4, (255,255,255), 1)
    cv2.putText(image, "Pred:  " , (625,45), cv2.FONT_HERSHEY_SIMPLEX, .4,
                    (255,255,255), 1)
...
#-----------calling functions  
    ...
    textDisp(framenumber,Img,currentcars,carids,fps,frames_count)
